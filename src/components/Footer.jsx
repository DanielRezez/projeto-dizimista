function Footer() {
    return(
        <>
            <footer className="print:hidden flex flex-col items-center pt-[15px] px-[10px] bg-[#222222] w-full h-[230px]">
                ...
                <div className="flex gap-[40px] max-[360px]:mt-[5px] min-[460px]:mt-[35px]">
