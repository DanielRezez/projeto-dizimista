function Header() {
    return(
        <>
            <header className="relative flex items-end justify-around bg-[#A10013] w-full h-[100px] fixed px-4">
                ...
                <img className="absolute w-40 h-40 top-20" src="./src/assets/Logo.png" />
                <nav className="flex items-center gap-10 text-white font-bold pb-6 md:gap-4">
