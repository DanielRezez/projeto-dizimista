function Header() {
    return(
        <>
            <header className="relative flex justify-around items-center bg-[#A10013] w-full h-[100px] fixed px-4">
                ...
                <nav className="flex items-end gap-10 text-white font-bold md:gap-4">
