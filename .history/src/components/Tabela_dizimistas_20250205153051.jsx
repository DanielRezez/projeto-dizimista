            ...
            <table>
                ...
                {dizimistas.map((dizimista, index) => (
                        <tr key={index} className={`${index % 2 === 0 ? "bg-[#EDDBB8]" : "bg-white"} border-b border-[#A10013]`}>
                            ...
                            <td className="px-4 py-2 text-center">{pessoa.ficha}</td>
                            <td className="px-4 py-2 text-center font-bold">{dizimista.nome}</td>
                            <td className="px-4 py-2 text-center">{pessoa.situaçao}</td>
                            <td className="px-4 py-2 text-center">{pessoa.editar}</td>
                        </tr>
                    ))}
                </tbody>
            </table>
