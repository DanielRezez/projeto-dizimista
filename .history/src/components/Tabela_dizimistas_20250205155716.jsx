...
<table className="w-full">
                <thead>
                    <tr className="bg-[#A10013] text-white">
                        <th className="px-4 py-2 width-[10%]">Sistema</th>
                        <th className="px-4 py-2 width-[10%]">Ficha</th>
                        <th className="px-4 py-2 width-[10%]">Nome</th>
                        <th className="px-4 py-2 width-[20%]">Situação</th>
                        <th className="px-4 py-2 width-[30%]">Editar</th>
                    </tr>
                </thead>
                <tbody>
                {dizimistas.map((dizimista, index) => (
                        <tr key={index} className={`${index % 2 === 0 ? "bg-[#EDDBB8]" : "bg-white"} border-b border-[#A10013]`} >
                            ...
                            <td className="px-4 py-2 text-center font-bold">{dizimista.nome}</td>
                            <td className="px-4 py-2 text-center">{dizimista.situaçao}</td>
                            <td className="px-4 py-2 text-center"><img src="./src/assets/pencil.svg" />a</td>
                        </tr>
                    ))}
                </tbody>
            </table>
