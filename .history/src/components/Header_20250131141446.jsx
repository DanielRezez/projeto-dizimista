        ...
        <>
            <header className="relative flex justify-around bg-[#A10013] w-full h-[100px] fixed">
                ...
                <nav className="flex items-center gap-4">
                    <a className="hidden md:block">PÁGINA INICIAL</a>
                    <img className="hidden md:block" src="./src/assets/cruz.svg" />
                    <a className="hidden md:block">GESTÃO DOS DIZIMISTAS</a>
                    <img className="hidden md:block" src="./src/assets/cruz.svg" />
                    <a className="hidden md:block">PERFIL</a>
                </nav>
            </header>
        </>
    )
