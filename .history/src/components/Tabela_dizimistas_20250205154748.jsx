            ...
            <table className="w-full">
                <thead>
                    <tr className="bg-[#A10013] text-white">
                        <th className="px-4 py-">Sistema</th>
                        <th className="px-4 py-">Ficha</th>
                        <th className="px-4 py-">Nome</th>
                        <th className="px-4 py-2text-center">Situação</th>
                        <th className="px-4 py-2text-right">Editar</th>
                    </tr>
                </thead>
                <tbody>
                    {dizimistas.map((dizimista, index) => (
                        <tr key={index} className={`${index % 2 === 0 ? "bg-[#EDDBB8]" : "bg-white"} border-b border-[#A10013]`}>
                            ...
                            <td className="px-4 py-2 font-bold whitespace-nowrap">{dizimista.nome}</td>
