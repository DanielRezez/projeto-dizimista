        ...
        <>
            <section class="@container bg-[url('src/assets/Background-login.jpg')] bg-cover h-screen flex flex-col items-center justify-start pt-8 md:bg-contain md:flex-row">
                <section className="flex flex-col items-center gap-5 md:flex-row">
                    <div className="">
                        <div className=""></div>
                        <img className="w-4/5 md:w-100" src="./src/assets/Logo.png" class="center"/>
                    </div>
                    {/*image-space*/}
                    <div className="">
                        ...
                        <p className="text-base hidden md:block md:text-white md:font-light md:w-3/5">Sistema desenvolvido para a fácil gestão de aniversariantes da Paróquia Matriz Santo Antônio de Pádua - Natal RN e comunidade.</p>
                    </div>
                </section>
