    ...
    return (
        <Layout>
            <section className="w-full max-w-[90%] mx-auto flex flex-col relative p-20 bg-[#9D988D] mt-10 mb-30">
                ...
                <div className="absolute -top-15 left-1/2 -translate-x-1/2 w-[120px] h-[120px] rounded-full overflow-hidden cursor-pointer sm:-top-30 sm:w-[180px] sm:h-[180px]  md:w-[260px] md:h-[260px]">
                    <input 
                        type="file" 
                        accept="image/*" 
                        className="hidden" 
                ...
                <form className="flex flex-col mx-auto text-left gap-4 mt-40 bg-blue-500">
                    <label htmlFor="input-usuario">Nome:</label>
                    <input id="input-usuario" placeholder="@Usuário" type="text" className="w-300" />
