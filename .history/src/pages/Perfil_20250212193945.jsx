        ...
        <Layout>
            <section className="w-full max-w-[90%] mx-auto flex flex-col relative p-20 bg-[#9D988D] mt-10 mb-30">
                ...
                <form className="flex flex-col mx-auto text-left gap-4 mt-40 text-[#F2EDE2]">
                    ...
                    <input id="input-usuario" placeholder="@Usuário" type="text" className="w-[600px] border-1 border-white rounded-md p-2" />
                    <label htmlFor="input-senha-atual" className="font-bold text-xl">Senha atual:</label>
                    <input id="input-senha-atual" placeholder="********" type="password" className="w-[600px] border-1 border-white rounded-sm p-2" />
                    <label htmlFor="input-nova-senha" className="font-bold text-xl">Nova senha:</label>
                    <input id="input-nova-senha" placeholder="********" type="password" className="w-[600px] border-1 border-white rounded-sm p-2" />
                </form>
            </section>
        </Layout>
    );
