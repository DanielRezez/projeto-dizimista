...
function Login() {
    return (
        <>
            <section class="@container bg-[url('src/assets/Background-login.jpg')] bg-cover h-screen flex flex-col items-center justify-center pt-8 md:bg-contain lg:flex-row">
                <section className="flex flex-col items-start md:gap-5 md:flex-row">
                    <div className="">
                        <div className=""></div>
                        <img className="border-10 w-60 md:w-[553px] md:min-w-[350px]" src="./src/assets/Logo.png" class="center"/>
                    </div>
                    {/*image-space*/}
                    <div className="">
                ...
                <section className="flex flex-col items-center gap-5 mt-30 bg-black opacity-35 rounded-[15px] w-[480px]">
