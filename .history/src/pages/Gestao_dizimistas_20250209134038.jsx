    ...
    return (
        <Layout>
            <div className="flex flex-col items-center justify-start min-h-screen w-full px-4">
                ...
                <section className="flex flex-col items-center w-full max-w-[1280px] min-h-[60%] h-auto bg-gradient-to-t from-[#EDE8DD] to-[#FFFFFF] shadow-lg rounded-lg p-5">
                    <div className=" overflow-x-auto">
                        <Tabela_dizimistas pagina={paginaAtual} itensPorPagina={itensPorPagina} />   
                    </div>

                    <div className="flex justify-center w-3/5 bg-500-200 mt-24">
                        {paginas.map((num) => (
                            <button
                            key={num}
