    ...
    return (
        <Layout>
            <section className="w-full max-w-[90%] mx-auto flex flex-col relative p-20 bg-gray-500 mt-10">
                ...
                <div className="absolute -top-15 left-1/2 -translate-x-1/2 w-[120px] h-[120px] border-[10px] border-[#F2EDE2] backdrop-blur-md rounded-full overflow-hidden cursor-pointer sm:-top-30 sm:w-[180px] sm:h-[180px]  md:w-[260px] md:h-[260px]">
                    <input 
                        type="file" 
                        accept="image/*" 
                        className="hidden" 
