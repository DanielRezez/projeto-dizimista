        ...
        <>
            <section className="@container bg-[url('src/assets/Background-login.jpg')] bg-cover h-full min-h-screen flex flex-col items-center justify-start md:items-center md:justify-center md:bg-contain md:flex-row">
                <section className="flex flex-col items-center md:gap-5 md:flex-row md:items-start">
                    <div className="">
                        <div className="xl:h-[728px] lg:w-[2px] lg:bg-white lg:absolute lg:top-[50%] translate-y-[-50%] min-[1480px]:left-35 min-[1200px]:left-30"></div>
                    ...
                    <div className="">
                        ...
                        <h1 className="text-[#C9942B] leading-2 text-center font-bold text-[32px] lg:text-[68px] leading-20 uppercase xl:block md:hidden lg:text-left">Dizimista</h1>
