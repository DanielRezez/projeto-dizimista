        ...
        <>
            <section className="@container bg-[url('src/assets/Background-login.jpg')] bg-cover h-full min-h-screen flex flex-col items-center justify-start md:items-center md:justify-center md:bg-contain md:flex-row">
                <section className="flex flex-col items-center md:gap-5 md:flex-row md:items-start">
                    ...
                    {/*image-space*/}
                    <div className="">
                        <h1 className="text-white text-center lg:text-[38px] uppercase font-medium md:text-left xl:block md:hidden">Portal do</h1>
                        <h1 className="text-[#C9942B] text-center font-bold lg:text-[68px] leading-20 uppercase xl:block md:hidden lg:text-left">Dizimista</h1>
                ...
                <section className="flex flex-col items-center gap-5 h-5/5 bg-black/35 rounded-[15px] h-[728px] pt-[105px] mt-40 md:w-[480px] md:mr-[111px]">
