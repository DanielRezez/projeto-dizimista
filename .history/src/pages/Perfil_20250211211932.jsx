    ...
    return (
        <Layout>
            <section className="w-full max-w-[90%] mx-auto flex flex-col relative p-20 bg-gray-500 mt-10">
                ...
                <div className="absolute -top-10 left-1/2 -translate-x-1/2 w-[120px] h-[120px] bg-blue-500 border-10 border-[#F2EDE2] rounded-full overflow-hidden cursor-pointer sm:-top-30 sm:w-[200px] sm:h-[200px]  md:w-[260px] md:h-[260px]">
                    <input 
                        type="file" 
                        accept="image/*" 
                        className="hidden" 
