    ...
    return (
        <Layout>
            <section className="w-full max-w-[90%] mx-auto flex flex-col relative p-20 bg-[#9D988D] mt-10 mb-30">
                ...
                <div className="absolute -top-15 left-1/2 -translate-x-1/2 w-[120px] h-[120px] bg-white border-[#F2EDE2] border-5 rounded-full overflow-hidden cursor-pointer sm:-top-30 sm:w-[180px] sm:h-[180px]  md:w-[260px] md:h-[260px]">
                    <input 
                        type="file" 
                        accept="image/*" 
                        className="hidden" 
                ...
                <form className="flex flex-col mx-auto text-left gap-4 mt-40 text-[#F2EDE2] max-w-[90%]">
                    ...
                    <input id="input-usuario" placeholder="@Usuário" type="text" className="w-[600px] max-w-[100%] border-1 border-white rounded-md p-2" />
                    <label htmlFor="input-senha-atual" className="font-bold text-xl">Senha atual:</label>
                    <input id="input-senha-atual" placeholder="********" type="password" className="w-[600px] max-w-[100%] border-1 border-white rounded-sm p-2" />
                    <label htmlFor="input-nova-senha" className="font-bold text-xl">Nova senha:</label>
                    <input id="input-nova-senha" placeholder="********" type="password" className="w-[600px] max-w-[100%] border-1 border-white rounded-sm p-2" />
                </form>
            </section>
        </Layout>
    );
