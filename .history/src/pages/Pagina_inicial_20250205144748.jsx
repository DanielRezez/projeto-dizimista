                ...
                <div className="flex justify-center w-full">
                    <section className="@container max-w-[90%] px-5 my-[115px] w-[1280px] h-[720px] bg-linear-to-t from-[#EDE8DD] to-[#FFFFFF]">
                        ...
                        <div className="flex flex-col items-start gap-4 my-[58px] md:flex md:flex-row md:justify-around md:flex-wrap">
                            ...
                            <button className="flex items-center gap-4 cursor-pointer text-[#C9942B] font-bold text-[1.375rem]"><img src="./src/assets/printer.svg" />IMPRIMIR</button>
                        </div>

                        <ul className="flex flex-col ">
                            <LiComponent>
                                <h3 className="font-bold">João Damasceno</h3>
                                <h3 classNme="font-regular">03/01</h3>
                            </LiComponent>
                            <LiComponent>
                                <h3 className="font-bold">Maria de Souza</h3>
                                <h3 className="font-regular">07/01</h3>
                            </LiComponent>
                            <LiComponent>
                                <h3 className="font-bold">Beatriz Monteiro</h3>
                                <h3 className="font-regular">09/01</h3>
                            </LiComponent>
                            <LiComponent>
                                <h3 className="font-bold">Pedro Henrique</h3>
                                <h3 className="font-regular">14/01</h3>
                            </LiComponent>
                        </ul>
                    </section>
                </div>
