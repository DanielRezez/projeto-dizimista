...
function Login() {
    return (
        <>
            <section className="@container bg-[url('src/assets/Background-login.jpg')] bg-cover h-screen flex flex-col items-center justify-start md:items-center md:justify-between md:bg-contain min-[1200px]:flex-row">
                <section className="flex flex-col items-center md:gap-5 md:flex-row md:items-start">
                    <div className="">
                        <div className="min-[1200px]:h-[728px] min-[1200px]:w-[2px] min-[1200px]:bg-white min-[1200px]:absolute min-[1200px]:top-[50%] min-[1200px]:translate-y-[-50%] min-[1200px]:lg:left-20"></div>
                    ...
                    <div className="">
                        ...
                        <h1 className="text-[#C9942B] text-center font-bold text-[68px] leading-20 uppercase md:text-left md:mr-[10px]">Dizimista</h1>
