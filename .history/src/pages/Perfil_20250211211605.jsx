    ...
    return (
        <Layout>
            <section className="w-full max-w-[90%] mx-auto flex flex-col relative p-20 bg-gray-500">
                ...
                <div className="absolute -top-26 left-1/2 -translate-x-1/2 w-[260px] h-[260px] bg-blue-500 border-10 border-[#F2EDE2] rounded-full overflow-hidden cursor-pointer">
                    <input 
                        type="file" 
                        accept="image/*" 
                        className="hidden" 
