            ...
            <section className="@container bg-[url('src/assets/Background-login.jpg')] bg-cover h-screen flex flex-col items-center justify-start md:items-center md:bg-contain lg:flex-row">
                <section className="flex flex-col items-center md:gap-5 md:flex-row md:items-start">
                    ...
                    <div className="">
                        ...
                        <p className="text-base hidden md:block md:text-white md:font-light md:text-justify md:mt-[38px] md:max-w-[100px]">Sistema desenvolvido para a fácil gestão de aniversariantes da Paróquia Matriz Santo Antônio de Pádua - Natal RN e comunidade.</p>
                    </div>
                </section>
