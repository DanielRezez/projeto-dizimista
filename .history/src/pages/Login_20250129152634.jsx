        ...
        <>
            <section class="@container bg-[url('src/assets/Background-login.jpg')] bg-cover h-screen flex flex-col items-center justify-start pt-8 md:bg-contain lg:flex-row">
                <section className="flex flex-col items-center md:gap-5 md:flex-row md:items-start">
                    <div className="">
                        <div className=""></div>
                        <img className="w-60 md:w-[553px] md:min-w-[350px]" src="./src/assets/Logo.png"/>
                    </div>
                    {/*image-space*/}
                    <div className="">
                ...
                <section className="flex flex-col items-center gap-5 mt-30 bg-black bg-opacity-35 rounded-[15px] w-[480px] max-w-2/5">
