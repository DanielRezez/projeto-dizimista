            ...
            <Layout>
                <div className="w-full max-w-md mx-auto">
                    ...
                    <div className="flex border-b-2 border-gray-300">
                        ...
                        <button
                            className={`px-4 py-2 flex-1 text-center font-bold ${tabAtivo === "novosDizimista" ? "bg-red-500 text-white" : "bg-gray-200 text-gray-500"}`}
                            onClick={() => setTabAtivo("novosDizimista")}
                        >
                            Novos Dizimistas
                        </button>
                    </div>
