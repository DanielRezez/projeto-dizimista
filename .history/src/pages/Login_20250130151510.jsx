...
function Login() {
    return (
        <>
            <section className="@container bg-[url('src/assets/Background-login.jpg')] bg-cover h-dvh h-dvw flex flex-col items-center justify-start md:items-center md:justify-center md:bg-contain md:flex-row lg:h-screen">
                ...
                <section className="flex flex-col items-center gap-5 h-5/5 bg-black/35 rounded-[15px] md:w-[480px] md:h-3/5 xl:h-[728px] md:mr-[111px]">
